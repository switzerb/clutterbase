...
Allows users to manually link related items bidirectionally, with an optional note explaining the relationship. Related items are displayed on the item detail page and can be removed by any authenticated user.
