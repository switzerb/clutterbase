...
Core entity of the archive. Items represent digitized physical objects — photos, documents, and other files — with associated metadata. Only a file and title are required; all other metadata is optional and editable after creation.
