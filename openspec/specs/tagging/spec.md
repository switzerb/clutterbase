...
Organizes items using a structured, category-based tagging system. Tags belong to admin-managed categories (default: place, event, topic, format) and are shared across all members of an organization.
