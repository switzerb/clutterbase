...
Authentication and authorization for the Clutterbase application. Ensures only authenticated users can access data, supports email and Google sign-in, enforces organization-scoped data isolation, and defines an admin role for privileged operations.
