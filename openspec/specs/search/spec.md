...
Enables users to find items through keyword search across title and description, and to filter by tags, people, date range, and file type. All search and filter constraints can be combined, and results can be sorted by item date or upload date.
